...
const (
	...
	gincontextPackage    = protogen.GoImportPath("github.com/go-kenka/kratos-gin/gincontext")
...
// generateFile generates a _gin.pb.go file containing kratos errors definitions.
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool) {
	...
	g.P("var _ = new(", gincontextPackage.Ident("GinData"), ")")
